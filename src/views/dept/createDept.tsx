...
import { TreeSelect, Modal, Form, Input, Select, message } from "antd";
import { ApiParams } from "@/types/api";
import API from "@/api";

interface CreateDeptProps {
  deptList: ApiParams.IDept[];
  getDeptList: () => void;
...
export default function CreateDept(props: CreateDeptProps) {
  ...
  const [userList, setUserList] = useState<ApiParams.IUser[]>([]);
